        ...
        @endphp
              ...
              <li class="nav-item {{ 
                  ...
                  ? 'menu-is-opening menu-open' : '' }}">
                    ...
                    @if ($canReadPencairanKomisiCustomer || $canReadPencairanKomisiDriver)
                        <ul class="nav nav-treeview">
                          <li class="nav-item {{ request()->is('pencairan_komisi_driver*')|| request()->is('pencairan_komisi_customer*')? 'menu-is-opening menu-open' : '' }}" style="font-size: 15px;">
                            <a href="#" class="nav-link">
                              <i class="far fa-circle nav-icon"></i>
                              <p style="font-weight: 500;" >
                                Pencairan Komisi
            ...
            @php
                $revisi = [
                            ...
                            'READ_REVISI_INVOICE_TRUCKING', 'READ_REVISI_TAGIHAN_REKANAN', 'READ_REVISI_TAGIHAN_PEMBELIAN', 'READ_REVISI_PEMBAYARAN_INVOICE'
                          ];
            @endphp
            {{-- REVISI --}}
