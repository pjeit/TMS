      ...
      <nav class="mt-2 ">
        <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent w-100" data-widget="treeview" role="menu"
          ...
          {{-- FINANCE --}}
            @php
            $finance = [
              'READ_BIAYA_OPERASIONAL',  'READ_PEMBAYARAN_JO', 'READ_PEMBAYARAN_SDT',
            ...
            @endphp
              ...
              <li class="nav-item {{ 
                      ...
                      request()->is('pembayaran_dokumen_kendaraan*')
                      ? 'menu-is-opening menu-open' : '' }}">
                <a href="#" class="nav-link hover-item" style="font-weight: 700;font-size: 15px;">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="{{route('pembayaran_dokumen_kendaraan.index')}}"
                      class="nav-link {{request()->url() === route('pembayaran_dokumen_kendaraan.index')? ' active' : '' }} "
                      style="font-weight: 500;">
                      <i class="far fa-circle nav-icon" style="font-size: 15px;"></i>
                      <span style="font-size: 0.9em;">Pembayaran Kendaraan</span>
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item   {{ 
                    ...
                    <ul class="nav nav-treeview">
                      <li class="nav-item">
                        <a href="{{route('pembayaran_karantina.index')}}" style="font-weight: 500;"
                          class="nav-link {{request()->is('pembayaran_karantina*') ? 'active' : ''  }}">
                          <i class="far fa-circle nav-icon" style="font-size: 15px;"></i>
                          <p>
                            Karantina
                          </p>
