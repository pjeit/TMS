...
<div class="container-fluid">
        <form action="{{ route('pengaturan_keuangan.update', [$dataPengaturanKeuangan->id]) }}" method="POST" >
        @csrf
        @method('PUT')
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" style="width: 100%;" id='uang_jalan' name="uang_jalan">
                                    @foreach ($dataMKas as $item)
                                        <option value="{{ $item->id }}" <?= ($item->id == $dataPengaturanKeuangan->uang_jajan)? 'selected':''; ?> >{{ $item->nama }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" style="width: 100%;" id='reimburse' name="reimburse">
                                    @foreach ($dataMKas as $item)
                                        <option value="{{ $item->id }}" <?= ($item->id == $dataPengaturanKeuangan->reimburse)? 'selected':''; ?> >{{ $item->nama }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" style="width: 100%;" id='penerimaan_customer' name="penerimaan_customer">
                                    @foreach ($dataMKas as $item)
                                        <option value="{{ $item->id }}" <?= ($item->id == $dataPengaturanKeuangan->penerimaan_customer)? 'selected':''; ?> >{{ $item->nama }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" style="width: 100%;" id='pembayaran_supplier' name="pembayaran_supplier">
                                    @foreach ($dataMKas as $item)
                                        <option value="{{ $item->id }}" <?= ($item->id == $dataPengaturanKeuangan->pembayaran_supplier)? 'selected':''; ?> >{{ $item->nama }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" style="width: 100%;" id='pembayaran_gaji' name="pembayaran_gaji">
                                    @foreach ($dataMKas as $item)
                                        <option value="{{ $item->id }}" <?= ($item->id == $dataPengaturanKeuangan->pembayaran_gaji)? 'selected':''; ?>  >{{ $item->nama }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" style="width: 100%;" id='hutang_karyawan' name="hutang_karyawan">
                                    @foreach ($dataMKas as $item)
                                        <option value="{{ $item->id }}" <?= ($item->id == $dataPengaturanKeuangan->hutang_karyawan)? 'selected':''; ?> >{{ $item->nama }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" style="width: 100%;" id='klaim_supir' name="klaim_supir">
                                    @foreach ($dataMKas as $item)
                                        <option value="{{ $item->id }}" <?= ($item->id == $dataPengaturanKeuangan->klaim_supir)? 'selected':''; ?> >{{ $item->nama }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <br>
                                <!-- <input type="number" class="form-control" name="batas_pemutihan" id="batas_pemutihan" value="<?= isset($dataPengaturanKeuangan->batas_pemutihan) ? $dataPengaturanKeuangan->batas_pemutihan:null; ?>"> -->
                                <div class="col-sm-12">
                                    <input id="batas_pemutihan" type="text" name="batas_pemutihan" value="<?= ($dataPengaturanKeuangan->batas_pemutihan)? $dataPengaturanKeuangan->batas_pemutihan:0; ?>">
                                </div>
                            </div>
                        </div>
                    </div>
