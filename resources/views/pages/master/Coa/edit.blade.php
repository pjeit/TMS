        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Ubah Coa</h5>
                </div>
                        ...
                        <div class="row justify-content-center g-2">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input require type="text" maxlength="20" name="nama_jenis" class="form-control" value="{{old('nama_jenis',$coa->nama_jenis)}}" >                         
                                </div>
                                <div class="form-group">
                                    <label for="no_akun">No. akun</label>
                                    <input require type="number" maxlength="10" name="no_akun" class="form-control" value="{{old('no_akun',$coa->no_akun)}}" >                         
                                </div>  
                                <div class="form-group">
