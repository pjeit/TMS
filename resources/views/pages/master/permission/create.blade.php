...
<div class="container-fluid">
    <form action="{{ route('permission.store') }}" method="POST" id="post">
        @csrf
        <div class="row">
            <div class="col-lg-6">
                <div class="card radiusSendiri">
                    ...
                    <div class="card-body">
                        <div class="form-group col-md-12">
                            ...
                            <input required type="text" id="menu" name="menu" class="form-control " value="" >                         
                        </div>
                        <div class="form-group col-md-12">
                            <label for="">Action</label>
                            <input required type="text" id="action" name="action" class="form-control " value="" >                         
                        </div>
                        <div class="form-group col-md-12">
                            <label for="">Guard Name</label>
                            <input required type="text" id="guard_name" name="guard_name" class="form-control " value="web" >                         
                        </div>
                    </div>
                </div>
            </div>
