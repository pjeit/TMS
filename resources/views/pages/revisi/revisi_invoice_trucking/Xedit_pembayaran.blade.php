                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-0">
                                        ...
                                        <input type="text" autocomplete="off" name="tgl_bayar" class="form-control date" id="tgl_bayar" value="{{ date('d-M-Y', strtotime($data->tgl_pembayaran)) }}" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select class="select2" style="width: 100%" id="id_kas" required >
                                        <option value="">── PILIH SUPPLIER ──</option>
