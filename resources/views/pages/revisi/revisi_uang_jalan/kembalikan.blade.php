                ...
                <div class="card-body" >
                    <div class="" style="">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <label for="total_hutang">Total Hutang Karyawan</label>
                                <div class="input-group mb-0">
                                    <div class="input-group-prepend">
                            ...
                            {{-- <div class="form-group col-6">
                                ...
                                <div class="input-group mb-0">
                                    ...
                                    <input type="text" id="potong_hutang" name="potong_hutang" class="form-control uang " value="" readonly >                         
                                </div>
                            </div> --}}

                            <div class="form-group col-6">
                                <label for="uang_jalan">Uang Jalan Dikembalikan</label>
                                <div class="input-group mb-0">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">Rp</span>
                                    </div>
                                    <input type="text" maxlength="100" id="uang_jalan" name="uang_jalan" class="form-control uang " value="{{ number_format(abs($sewa->uang_jalan_gt - $sewa->total_uang_jalan)) }}" readonly>                         
                                    <input type="hidden" name="jenis" value="kembalikan">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-6">
                                ...
                                <div class="d-flex" style="gap: 10px;">
                                    <select class="form-control select2" required style="width: 100%;" id='pembayaran' name="pembayaran" data-live-search="true" data-show-subtext="true" data-placement="bottom">
                                        ...
                                        @endforeach
                                            <option value="HUTANG_KARYAWAN">HUTANG KARYAWAN</option>
                                    </select>
                                </div>  
                            </div>  
