            ...
            <table class="table table-hover table-bordered " width="100%" id="tabel_tagihan">
                ...
                <tbody id="hasil">
                    @foreach ($data->getRekanan as $key => $rekanan)
                        <tr style="background: #ffffffc0" class="tr_{{ $rekanan->id }}" id="{{$key}}">
                            <td colspan="2">{{ $rekanan->no_nota }}
                                <input type="hidden" id="id_nota_{{ $key }}" value="{{ $rekanan->id }}" name="data[{{ $rekanan->id }}][id_nota]" class="all_id_nota">
                            ...
                            <td class="text_bukti_potong_${id}">${no_bukti_potong}</td>
                             --}}
                            <td style="text-align: right;"  class="font-weight-bold">{{number_format($rekanan->total_tagihan)}}</td>
                            ...
                            <td>
                                <div class="btn-group dropleft">
                                    ...
                                    <div class="dropdown-menu" >
                                        <button class="btn dropdown-item openDetail" value="{{ $key }}" id_nota_add = "{{ $rekanan->id }}">
                        ...
                        @foreach ($rekanan['getDetails'] as $item)
                            <tr style="background: #ffffff" class="tr_{{ $rekanan->id }}" id="{{$key}}">
                                <td></td>
