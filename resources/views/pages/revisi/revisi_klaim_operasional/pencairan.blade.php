...
<div class="container-fluid">
    ...
    @endif
    <form action="{{ route('pencairan_klaim_operasional_revisi.save',[$klaim_ops->id]) }}" method="POST" id="post" >
        @csrf
        @method('post')
        <div class="card radiusSendiri">
            <div class="card-header">
                <a href="{{ route('klaim_operasional_revisi.index') }}"class="btn btn-secondary radiusSendiri"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Kembali</a>
