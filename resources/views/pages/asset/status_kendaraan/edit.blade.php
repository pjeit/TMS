                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-lg-6 col-md-6 col-sm-12" id="kir_form">
                            ...
                            <div class="icheck-primary d-inline">
                                <input id="kir_Y" type="radio" name="kir" value="Y" {{$dataStatusKendaraan->is_kir=='Y'?'checked':''}}>
                                <label class="form-check-label" for="kir_Y">Ya</label>
                            </div>
                            <div class="icheck-primary d-inline ml-5">
                                <input id="kir_N" type="radio" name="kir" value="N" {{$dataStatusKendaraan->is_kir=='N'?'checked':''}}>
