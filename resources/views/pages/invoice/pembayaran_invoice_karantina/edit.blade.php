        ...
        <div style="overflow: auto;">
            <table class="table table-hover table-bordered table-striped " width='100%' id="table_invoice">
                ...
                @isset($data)   
                    <tr>
                        <td> 
                            <span id="text_no_invoice">{{ $data['no_invoice'] }}</span>
                            <input type="hidden" id="no_invoice_{{ $data->id }}" name="detail[{{ $data->id }}][no_invoice]" value="{{ $data->no_invoice }}">
                            <input type="hidden" id="no_bukti_potong_{{ $data->id }}" name="detail[{{ $data->id }}][no_bukti_potong]" value="{{ $data->no_bukti_potong }}">
                        </td>
                        <td> 
                            <span id="text_total_tagihan_{{ $data->id }}">{{ number_format($data->total_tagihan) }}</span>
                            <input type="hidden" class="total_tagihan" id="total_tagihan_{{ $data->id }}" name="detail[{{ $data->id }}][total_tagihan]" value="{{ $data->total_tagihan }}">
                        </td>
                        <td> 
                            <span id="text_total_sisa_{{ $data->id }}">{{ number_format($data->total_sisa) }}</span>
                            <input type="hidden" class="total_sisa" id="total_sisa_{{ $data->id }}" name="detail[{{ $data->id }}][total_sisa]" value="{{ $data->total_sisa }}">
                        </td>
                        <td>
                            <span id="text_pph23_{{ $data->id }}"></span>
                            <input type="hidden" class="total_pph23" id="total_pph23_{{ $data->id }}" name="detail[{{ $data->id }}][pph23]" value="{{ $data->pph23 }}">
                            <input type="hidden" class="total_dibayar" id="total_dibayar_{{ $data->id }}" name="detail[{{ $data->id }}][dibayar]" value="{{ $data->dibayar }}">
                        </td>
                        <td>
                            <span id="text_diterima_{{ $data->id }}"></span>
                            <input type="hidden" class="total_diterima" id="total_diterima_{{ $data->id }}" name="detail[{{ $data->id }}][diterima]" value="{{ $data->diterima }}">
                        </td>
    
                        {{-- <td>
                            <span id="text_dibayar_{{ $data->id }}"></span>
                            <input type="hidden" class="total_dibayar" id="total_dibayar_{{ $data->id }}" name="detail[{{ $data->id }}][dibayar]" value="{{ $data->dibayar }}">
                        </td> --}}
                        <td>
                            <span id="text_catatan_{{ $data->id }}">{{ $data->catatan }}</span>
                            <input type="hidden" id="catatan_{{ $data->id }}" name="detail[{{ $data->id }}][catatan]" value="{{ $data->catatan }}">
                        </td>
                        <td>
                            <div class="btn-group dropleft">
                                ...
                                <div class="dropdown-menu">
                                    <button type="button" name="detail" id="detail_{{$data->id}}" class="detail dropdown-item"> 
                                        <span class="fas fa-edit mr-3"></span> Edit
                                    </button>
                                    <a href="{{ route('pembayaran_invoice.destroy', ['pembayaran_invoice' => $data->id]) }}" class="dropdown-item" data-confirm-delete="true">
