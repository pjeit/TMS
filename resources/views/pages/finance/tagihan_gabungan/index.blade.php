...
<div class="container-fluid">
    <div class="card radiusSendiri">
        <form action="{{ route('tagihan_gabungan.bayar') }}" id="bayar" method="POST" >
            @csrf
            <div class="card-header">
                <a href="{{ route('tagihan_gabungan.create') }}"  class="btn btn-primary radiusSendiri"> <i class="fa fa-plus-circle"></i> Data Baru</a>
                                                ...
                                                <div class="btn-group dropleft">
                                                    ...
                                                    <div class="dropdown-menu" >
                                                        {{-- @can('CAN_EDIT_TAGIHAN_REKANAN') --}}
                                                            <a href="{{ route('tagihan_gabungan.edit', [$item->id]) }}" class="dropdown-item update_resi">
                                                                <span class="fas fa-pen-alt mr-3"></span> Edit
                                                            </a>
                                                        {{-- @endcan --}}
                                                        @if ($item->tagihan_dibayarkan==0)
                                                            <a href="{{ route('tagihan_gabungan.destroy', $item->id) }}" class="dropdown-item" data-confirm-delete="true">
