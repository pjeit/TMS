...
<section class="container-fluid">
    <form action="{{ route('tagihan_gabungan.store') }}" id="save" method="POST">
        @csrf
        <div class="radiusSendiri sticky-top" style="margin-bottom: -15px;">
            <div class="card radiusSendiri" style="">
                <div class="card-header radiusSendiri">
                    <a href="{{ route('tagihan_gabungan.index') }}" class="btn btn-secondary radiusSendiri"><i
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        row.append(`<td>${moneyMask(data[i].total_tarif)}
                            </td>`)
                        row.append(`<td>
