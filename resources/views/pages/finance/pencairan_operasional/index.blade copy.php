...
<div class="container-fluid">
    <div class="card radiusSendiri">
        {{-- <div class="row"> --}}
            ...
            <div class="card-body">
                <table id="rowGroup" class="table table-bordered table-striped" width=''>
                    <thead>
                        <tr>
                            <th>Name</th>
                            <th>Position</th>
                        ...
                        @if (isset($data))
                            ...
                            @foreach($data as $item)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-success radiusSendiri" href="{{route('pencairan_operasional.pencairan',[$item->id_jo])}}">
