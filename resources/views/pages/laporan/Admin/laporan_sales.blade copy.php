        ...
        $('body').on('click','#btnCari', function (){
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    //             row.append(`<td>${data[i].no_sewa} ${dateMask(data[i].tanggal_berangkat)}</td>`);//sewa
                    //             row.append(`<td>${data[i].get_customer.nama} - [${data[i].get_karyawan?data[i].get_karyawan.nama_panggilan:'DRIVER REKANAN : '+data[i].get_supplier.nama}]</td>`);//customer dan driver
                    //         }
                    //         else if(tipe_group=='driver')
                    //         {
                    //             row.append(`<td>${data[i].get_karyawan?data[i].get_karyawan.nama_panggilan:'DRIVER REKANAN : '+data[i].get_supplier.nama}</td>`);//driver
                    //             row.append(`<td>${data[i].no_sewa} ${dateMask(data[i].tanggal_berangkat)}</td>`);//sewa
                    //             row.append(`<td>${data[i].get_customer.nama} - [${data[i].no_polisi} (${data[i].karoseri?data[i].karoseri:'-'})]</td>`);//customer dan tujuan
                    //         }
                    ...
                    //         // <th>Lain-Lain</th>
                    //         // <th>Profit</th>
                    //         row.append(`<td>${data[i].total_tarif}</td>`);//Tarif
                    //         row.append(`<td>${data[i].total_uang_jalan}</td>`);//uj
                    //         row.append(`<td>${data[i].total_komisi?data[i].total_komisi:0}</td>`);//customer komisi
                    //         row.append(`<td>${data[i].total_komisi_driver?data[i].total_komisi_driver:0}</td>`);//driver komisi
                    //         row.append(`<td>${data[i].nama}</td>`);//Reimburse
                    //         row.append(`<td>${data[i].nama}</td>`);//Lain-Lain
                    //         row.append(`<td>${data[i].nama}</td>`);//Profit
