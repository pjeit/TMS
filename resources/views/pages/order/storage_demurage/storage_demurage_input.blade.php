             ...
             <div class="col-12">
                <div class="card radiusSendiri">
                    ...
                    <div class="card-body">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title"><b>JOB ORDER</b></h3>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group ">
                                            ...
                                            <input required type="text" name="no_bl" class="form-control" value="{{$data['detail']}}" readonly disabled >
                                        </div>           
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                        @if ($data['detail'])
                                            {{-- @foreach (json_decode($data['detail']) as $key => $item)
                                                <tr id="row{{$key}}" style="background: #f2f2f2;">
                                                    <td>
                                                    ...
                                                    <td>
                                                        <select class="form-control selectpicker tujuanC" name="detail[{{$key}}][tujuan]" id="tujuan{{$key}}" data-live-search="true" data-show-subtext="true" data-placement="bottom" disabled>
                                                    ...
                                                    <td >
                                                        <div class="input-group mb-0">
                                                            ...
                                                            <input type="text" name="detail[{{$key}}][tgl_booking]" id='tgl_booking' autocomplete="off" class="date form-control tgl_booking" placeholder="dd-M-yyyy" value="{{ isset($item->tgl_booking)? \Carbon\Carbon::parse($item->tgl_booking)->format('d-M-Y'):NULL;}} " disabled>     
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <button class="btn btn-primary btn-xs no-action" data-toggle="collapse" data-target="#demo{{$key}}" class="accordion-toggle"><i class="fa fa-chevron-circle-down" aria-hidden="true"></i> {{$key}}</button>
                                                    </td>
                                                </tr>
                                                <tr>
...
<script>
    $( document ).ready(function() {
        ...
        //     scrollX: true
        // });
        $( document ).on( 'click', '.no-action', function (event) {
