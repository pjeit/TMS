            ...
            $('#tampunganTabel').append(
                `
                    <tr id="${maxID}">
                        <td>
                            <div class="icheck-success d-inline">
                                <input type="checkbox" id="checkboxPrimary_${maxID}" class="centang_cekbox" >
                        ...
                        <td style="width:1px; white-space: nowrap; text-align:center;" id="ditagihkan_tabel_${maxID}" >
                            <div class="icheck-primary d-inline">
                                <input type="checkbox" id="checkTagih_data_${maxID}" class="cek_tagih" name="data[${maxID}][ditagihkan_data]"  >
                                <label for="checkTagih_data_${maxID}"></label>
                                <input type="hidden" class="value_cek_tagih" name="dataLain[${maxID}][ditagihkan_data_value]"  value="">
                            </div>
                        </td>
                        <td style="width:1px; white-space: nowrap; text-align:center;" id="dipisahkan_tabel_${maxID}" >
                            <div class="icheck-primary d-inline">
                                <input type="checkbox" id="checkPisah_data_${maxID}" class="cek_pisah" name="data[${maxID}][dipisahkan_data]"  >
                                <label for="checkPisah_data_${maxID}"></label>
                                <input type="hidden" class="value_cek_dipisahkan_data" name="dataLain[${maxID}][dipisahkan_data_value]"  value="">
