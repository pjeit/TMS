                ...
                <div class="card radiusSendiri">
                    <div class="card-body">
                        <table class="table table-bordered card-outline card-primary " id="sortable" >
                              <thead>
                                  <tr>
                                      <th colspan="6">BIAYA PERJALANAN</th>
                                  </tr>
                                <tr>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        centangCheckbox.each(function() {
            ...
            var deskripsi = row.find('#deskripsi_data_' + index);
            var nominal = row.find('#nominal_data_' + index);
            var cekTagih = row.find('#checkTagih_data_' + index);
            var cekPisah = row.find('#checkPisah_data_' + index);
            var catatan = row.find('#catatan_data_' + index);

        });
        centangCheckbox.click(function () {
            var row = $(this).closest('tr'); 
            var index = row.attr('id'); 
        ...
        // // cek_pisah.closest('tr').find('.cek_pisah input[type="checkbox"]').prop('disabled',!cek_tagih.checked);
        // cek_tagih.click(function () {
        //      if ($(this).is(":checked")) {

        //          $(this).closest('tr').find('.cek_pisah input[type="checkbox"]').prop('disabled',false);
            
        //     } else if ($(this).is(":not(:checked)")) {
        //          $(this).closest('tr').find('.cek_pisah input[type="checkbox"]').prop('disabled',true);
