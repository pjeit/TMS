                                ...
                                @if ($data['detail'])
                                    @foreach (json_decode($data['detail']) as $key => $item)
                                        <tr id="row{{$key}}" >
                                            ...
                                            <td>
                                                <select class="form-control selectpicker jenis" name="detail[{{$key}}][jenis]" id="tipe{{$key}}" data-live-search="true" data-show-subtext="true" data-placement="bottom" readonly >
