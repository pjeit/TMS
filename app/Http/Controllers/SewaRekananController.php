...
class SewaRekananController extends Controller
{
    ...
    public function create()
    {
        ...
        ->select('s.*')
        ->where('s.is_aktif', '=', "Y")
        ->where('s.jenis_supplier_id',VariableHelper::Jenis_supplier_id('TAGIHAN REKANAN')) //jenis = tagihan rekanan
        ->get();
    ...
    public function edit(Sewa $truck_order_rekanan)
    {
        ...
        ->select('s.*')
        ->where('s.is_aktif', '=', "Y")
        ->where('s.jenis_supplier_id',VariableHelper::Jenis_supplier_id('TAGIHAN REKANAN'))
        ->get();
