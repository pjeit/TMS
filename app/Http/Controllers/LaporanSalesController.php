        ...
        try {
           ...
           $data = DB::table('sewa as s')
                    ->select(
                        ...
                        DB::raw("ifnull(ifnull(s.harga_jual,0),  ifnull(s.total_uang_jalan,0)) as total_uang_jalan"),
                        ...
                        DB::raw("s.total_tarif - ifnull(trd.total_tagihan, ifnull(s.total_uang_jalan,0)) - ifnull(s.total_komisi,0)  + ifnull(id.tambahan,0) - ifnull(id.diskon,0) as total_profit"),
